...
\begin{figure}[h]
  \centering
  \scalebox{.75}{\input{\mainpath/fig/pdf/FV_discretization_tetrahedra.pdf_tex}}
  \caption{\ac{FV} semi-discretization of an unstructured mesh. Vertex $i$ is the center of dual cell $C_i$. The primal element is drawn in thick black lines, the dual cell in dashed lines. The boundary of the dual cell is denoted as $\pd C_{ij}$}
