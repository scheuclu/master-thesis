...
printf "\033[92mSHAPEVARIABLES\033[00m:\n$shapevariables\n"
...
do
  ...
  do
    ...
    do
      ...
      do
        cp -r template_sim sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}
        ...
        #write siminfo file
        echo "machnumber: $curmach" >> sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/siminfo
        echo "perturb: $i" >> sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/siminfo
        echo "angle: $curangle" >> sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/siminfo

        #replace perturbation magnitude in SDESIGN file
        sed -i "s/<perturb_abs${curshapevar}>/$i/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/sdesign/naca_plus.sdesign
        sed -i "s/<perturb_abs${curshapevar}>/$i/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/sdesign/naca_minus.sdesign
        for j in `seq 1 10`;
        do
          sed -i "s/<perturb_abs${j}>/0.0/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/sdesign/naca_plus.sdesign
          sed -i "s/<perturb_abs${j}>/0.0/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/sdesign/naca_minus.sdesign
        done

        #replace angle of attach
        sed -i "s/<alpha>/$curangle/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/naca_plus.aerof.steady
        sed -i "s/<alpha>/$curangle/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/naca_minus.aerof.steady

        #replace machnumber
        sed -i "s/<machnumber>/$curmach/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/naca_plus.aerof.steady
        sed -i "s/<machnumber>/$curmach/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/naca_minus.aerof.steady

        #replace simulation index and path in run-script
        sed -i "s/<index_mach>/$index_mach/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/run_steady.sh
        sed -i "s/<index_angle>/$index_angle/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/run_steady.sh
        sed -i "s/<index_perturb>/$index_perturb/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/run_steady.sh
        sed -i "s/<index_shapevar>/$index_shapevar/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/run_steady.sh
        sed -i "s/<casepath>/$PWD/g" ./sim_${index_mach}_${index_angle}_${index_shapevar}_${index_perturb}/run_steady.sh
