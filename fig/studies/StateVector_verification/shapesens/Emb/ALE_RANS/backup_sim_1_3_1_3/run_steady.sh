...
#PBS -N sim_1_3_1_3_laminar
#PBS -M lscheuch@stanford.edu
#PBS -l nodes=1:ppn=12
#PBS -l walltime=48:00:00

CURRENT_DIR='/home/lscheuch/project/testcases_emb/shapesens/ALE_RANS/sim_1_3_1_3'
...
$XP2EXO_EXEC ./sdesign/embedded_surface_plus.top ./sdesign/embedded_surface_plus.exo
$XP2EXO_EXEC ./sdesign/embedded_surface_minus.top ./sdesign/embedded_surface_minus.exo
