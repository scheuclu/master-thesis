...
#$SOWER_EXECUTABLE -fluid -merge -con ../../../mesh/sower/fluid_sowered.con -mesh ../../../mesh/sower/fluid_sowered.msh -result ./rst/naca_steady.sol -output ./results/xpost/SteadySolutionolution
