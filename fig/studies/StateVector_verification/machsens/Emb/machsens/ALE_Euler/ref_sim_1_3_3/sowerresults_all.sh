...
$SOWER_EXECUTABLE -fluid -merge -con ../../../mesh/sower/fluid_sowered.con -mesh ../../../mesh/sower/fluid_sowered.msh -result ./results/FluidID -output ./results/xpost/FluidID -precision 15
