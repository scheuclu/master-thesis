...
for item in Velocity Density Pressure dFdS_final dFdS_viscous dFdS_inviscid DensitySensitivity MeshdispSensitivity MachSensitivity NuTildeSensitivity VelocitySensitivity PressureSensitivity StateVectorSensitivity TemperatureSensitivity TotalPressureSensitivity VelocityNormSensitivity; do
