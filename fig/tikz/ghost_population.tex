...
\node (v14) at (-1,0.5)         {};
\node (v16)[diamond, scale=0.3, draw=blue, fill=blue] at (-0.5,2)         {};
\node (v162) at (-0.5,2)        {};
\node[diamond, scale=0.3, draw=blue, fill=blue] (v20) at (-0.6486,3.6486) {};
\node (v22) at (1.6998,3.2006)  {};
\node (v24) at (2.7674,1.4979)  {};
\node (v26) at (2.4161,0.2952)  {};
\node[diamond, scale=0.3, draw=blue, fill=blue]  (v28) at (0.4566,0.4574)  {};
