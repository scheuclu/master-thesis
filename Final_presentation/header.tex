%%\documentclass[10pt, mathserif, show notes]{beamer}
%\documentclass[10pt, mathserif]{beamer}
\documentclass[10pt, mathserif, handout]{beamer}%for printing
\usepackage{pgfpages}
%\documentclass[10pt, mathserif, show only notes]{beamer}%only notes
