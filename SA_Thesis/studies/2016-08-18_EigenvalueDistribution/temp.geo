...
DefineConstant[ numele_x_per_sub = {4, Min 1, Max 1200, Step 1,
                         Name "2_NumEle/numele x per sub"} ];

DefineConstant[ numele_y_per_sub = {4, Min 1, Max 1200, Step 1,
...
DefineConstant[ tag_pattern1 = {1, Min 1, Max 9999, Step 1,
                         Name "4_Tags/tag_pattern1"} ];

DefineConstant[ tag_pattern2 = {2, Min 1, Max 9999, Step 1,
...
Physical Surface("surface material steel",1) = pattern1[];
Physical Surface("surface material rubber",2) = pattern2[];
